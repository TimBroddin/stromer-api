...
function () {
  ...
  _createClass(Settings, [{
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                _context.next = 5;
                return Promise.all([this.getMainSettings(), this.getSensorSettings(), this.getTuningSettings()]);
    ...
    key: "getTuningSettings",
    value: function () {
      var _getTuningSettings = _asyncToGenerator(
      /*#__PURE__*/
      ...
      return function getTuningSettings() {
        return _getTuningSettings.apply(this, arguments);
      };
    }()
  }]);
